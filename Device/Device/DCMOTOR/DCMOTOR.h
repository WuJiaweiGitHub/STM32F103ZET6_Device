...
//****************ENA配置************************/
#define MOTOR_ENA_TIMx 										TIM3
#define MOTOR_ENA_TIM_ARR 								100
#define MOTOR_ENA_TIM_PSC 								72
#define MOTOR_ENA_TIM_Pulse 							MOTOR_ENA_TIM_ARR * 0

#define MOTOR_ENA_TIM_CHECK_OC 						TIM_PWM_OC1_OPEN
#define MOTOR_ENA_TIM_OCx 								OC1 

//****************ENB配置************************/
#define MOTOR_ENB_TIMx 										TIM3
#define MOTOR_ENB_TIM_ARR 								100
#define MOTOR_ENB_TIM_PSC 								72
#define MOTOR_ENB_TIM_Pulse 							MOTOR_ENA_TIM_ARR * 0

#define MOTOR_ENB_TIM_CHECK_OC 						TIM_PWM_OC2_OPEN
#define MOTOR_ENB_TIM_OCx 								OC2 
